FROM debian
RUN apt update
RUN DEBIAN_FRONTEND=noninteractive apt install git lxde tightvncserver wget -y 
RUN DEBIAN_FRONTEND=noninteractive apt install firefox-esr mate-system-monitor openssh-server vim -y
